...
def index(request):
    ...
    html = f"<h1>Страница приложения tasks</h1><a href='{quality_control_index_url}'>Ссылка на главную страницу quality_control</a> <a href='{projects_list_url}'>Список проектов</a>"
